    ...
    <div>
      ...
      >
        <textarea
          ...
          className={cn(
            cn(
              `text-15 caret-old-primary-blue-800 h-full min-h-max w-full resize-none border-none p-0 font-medium text-gray-900 placeholder-gray-400 read-only:pointer-events-none focus:text-gray-700 focus:ring-0 focus:outline-hidden disabled:bg-gray-100 disabled:text-gray-400`,
              {
                'bg-gray-100': (readonly && readonlyBackground === 'bg-gray-100') || disabled,
                'cursor-not-allowed': readonly || disabled,
                'cursor-pointer': !readonly && !disabled,
