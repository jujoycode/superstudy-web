...
export function StudentIDCard({ meRecoil }: StudentIDCardProps) {
  ...
  return (
    <>
                  ...
                  {editMode ? (
                    <>
                      <label htmlFor="bg-upload">
                        <div className="cursor-pointer rounded-xl bg-neutral-500/50 p-2 text-sm text-white">
                          배경 업로드
                        </div>
                      </label>

                      <div
                        className="cursor-pointer rounded-xl bg-neutral-500/50 p-2 text-sm text-white"
              ...
              <div className="flex h-80 w-full flex-col items-center bg-[#FAFAFA]">
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td className="pr-3 text-xs text-gray-400">생년월일</td>
                      <td className="text-sm text-black">
                        {meRecoil?.birthDate && makeDateToString(meRecoil.birthDate, '.')}
                      </td>
                    </tr>
                    <tr>
                      <td className="pr-3 text-xs text-gray-400">유효기간</td>
      ...
      {modalOpen && (
        <div className={`fixed inset-0 z-60 flex h-screen w-full items-center justify-center bg-neutral-500/50`}>
