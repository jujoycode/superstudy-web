...
import { useAchievementCriteriaGetAll } from 'src/generated/endpoint';
import { AchievementChapter, AchievementCriteria } from 'src/generated/model';
      ...
      <div className="flex h-full w-full flex-col p-10">
        <div className="flex w-full items-center justify-between">
          <div className="flex items-center space-x-4">
            <h1 className="whitespace-nowrap text-xl font-bold">성취기준 선택</h1>
            <Select.lg
              value={docYear}
              onChange={(e) => {
              ...
              {(code ? achievementChapters : [selectedChapter])
                ...
                ?.map((criteria) => (
                  ...
                  >
                    ...
                    />
                    <div className="whitespace-pre-line font-semibold">{getCriteriaTitle(criteria)}</div>
                  </label>
                ))}
            </div>
          </div>
