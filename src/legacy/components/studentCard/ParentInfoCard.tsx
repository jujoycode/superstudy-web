          ...
          <>
            ...
            {reqParentName && id === studentId ? (
              <>
                ...
                <button
                  children="취소하기"
                  className="bg-light_orange text-brand-1 hover:text-light_orange my-1 rounded-md px-2 py-1 text-sm hover:bg-red-500 focus:outline-hidden"
                  onClick={() => {
                    alert('가입 요청을 취소합니다.')
              ...
              <div className="flex justify-end">
                {parentInfo.length < 2 && totalParent < 2 && (
                  <button
                    ...
                    className="bg-light_orange text-brand-1 hover:bg-brand-1 hover:text-light_orange mb-2 rounded-md px-2 py-1 text-sm focus:outline-hidden"
                  />
                )}
              </div>
            )}
              ...
              <>
                ...
                <div className="flex justify-end pt-2">
                  {addBtnParent && (
                    <button
                      children="취소"
                      className="bg-light_orange text-brand-1 hover:text-light_orange mr-1 mb-2 rounded-md px-2 py-1 text-sm hover:bg-red-500 focus:outline-hidden"
                      onClick={() => {
                        setAddBtnParent(false)
                        setNokName('')
                        setNokPhone('')
