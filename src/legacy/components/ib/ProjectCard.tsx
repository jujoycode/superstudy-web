...
import { ResponseCoordinatorSelfCheckDtoType, ResponseIBDto, ResponseUserDto } from 'src/generated/model';
...
function CasProjectCard({ data, user }: ProjectCardProps) {
  ...
  return (
    <div
      ...
      } w-[308px] cursor-pointer flex-col rounded-xl border border-primary-gray-200 bg-white shadow-[0_4px_8px_0_rgb(244,246,248)]`}
    >
      {/* flag 영역 */}
      {user.role !== 'USER' && data.leader.studentGroup && (
        <div className=" flex flex-row items-center justify-between border-b border-b-primary-gray-100 px-5 py-2">
          ...
          {data.status === 'WAIT_MENTOR' && data.mentor !== null && (
            <div className="flex flex-row items-center gap-1">
              ...
              <Typography variant="caption" className="font-medium text-primary-orange-800">
                감독교사 요청함
              </Typography>
            </div>
          )}
      ...
      <div className="flex w-[308px] flex-1 flex-col justify-between pt-5">
        ...
        <footer className="flex flex-col border-t border-t-primary-gray-100">
          {message && (
          ...
          <div className="flex flex-row items-center justify-between gap-3 border-t border-t-primary-gray-100 px-5 py-4">
  ...
  return (
    ...
    >
      ...
      <div className="flex w-[308px] flex-1 flex-col justify-between pt-5">
        ...
        {message && (
          <div className="flex flex-row items-center justify-between gap-3 border-t border-t-primary-gray-100 px-5 py-3">
            <div className="flex flex-row items-center gap-1">
              <ColorSVGIcon.New color="orange800" size={16} />
              <Typography variant="caption" className="text-primary-gray-700">
                {message}
...
function TokEsProjectCard({ data, user, permission }: ProjectCardProps) {
  ...
  return (
    <div
      className={`flex ${
        user.role === 'USER' ? 'h-[294px]' : 'h-[338px]'
      } w-[308px] flex-col rounded-xl border border-primary-gray-200 bg-white shadow-[0_4px_8px_0_rgb(244,246,248)]`}
    >
      {/* flag 영역 */}
      {user.role !== 'USER' && data.leader.studentGroup && (
        <div className=" flex flex-row items-center justify-between border-b border-b-primary-gray-100 px-5 py-2">
