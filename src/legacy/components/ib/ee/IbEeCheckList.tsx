...
import { RequestRRSDto } from 'src/generated/model';
    ...
    >
      <div className={`relative w-[632px] overflow-hidden rounded-xl bg-white px-8`}>
        ...
        <form>
          ...
          <div className="sticky bottom-0 flex h-[104px] justify-end gap-4 border-t border-t-primary-gray-100 bg-white/70 pb-8 pt-6 backdrop-blur-[20px]">
            <ButtonV2
              type="submit"
              variant="solid"
              color="orange800"
