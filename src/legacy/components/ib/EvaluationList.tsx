...
import { ResponseEEEvaluationRelationByStudentDto } from 'src/generated/model';
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between gap-1 rounded-lg bg-primary-orange-50 px-4 py-3">
          ...
          <Typography variant="title3" className="max-w-[206px] text-right text-primary-orange-800">
            {/* TODO: 각 기준별 채점한 score의 총합 계산 필요*/}
            {totalScore}점
          </Typography>
        </div>
        <div className="scroll-box max-h-[456px] overflow-y-scroll rounded-lg border border-primary-gray-200">
            ...
            >
              <div className="bg-primary-gray-50">
                {criteria.levels?.map((level) => (
                  <div
                    key={level.id}
                    className="flex flex-col gap-2 border-t border-primary-gray-200 bg-primary-gray-50 px-4 pb-2 first:pt-4 last:pb-4 [&:not(:first-child)]:pt-2"
                  >
