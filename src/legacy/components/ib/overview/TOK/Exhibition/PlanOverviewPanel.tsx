...
import { ResponseIBTokExhibitionPlanSubmissionStatusDto } from '@/legacy/generated/model'

interface OverviewPanelProps {
  goDetailPage?: (studentIbId: number, exhibitionId: number) => void
  data: ResponseIBTokExhibitionPlanSubmissionStatusDto[]
...
export default function PlanOverviewPanel(props: OverviewPanelProps) {
    ...
    return studentsToDisplay.reduce(
      ...
      {} as Record<
        string,
        {
          ...
          grade: number
          klass: number
          students: ResponseIBTokExhibitionPlanSubmissionStatusDto[]
        }
      >,
    )
  }, [studentsToDisplay])
            ...
            {group.students
              ...
              .map((student) => (
                <div
                  ...
                  onClick={goDetailPage ? () => goDetailPage(student.id, student.tokExhibitionPlan.id) : undefined}
                >
