...
interface OverviewPanelProps {
  ...
  title: string
  buttonText?: string
  type?: ResponseIBTKPPFSubmissionStatusDtoDetailStatus
  buttonHandler?: () => void
  buttonDisabled?: boolean
  className?: string
  action?: (studentIbId: number, tkppfId: number) => void
}

export default function TKPPFOverviewPanel(props: OverviewPanelProps) {
    ...
    return studentsToDisplay.reduce(
      ...
      {} as Record<
        string,
        {
          ...
          grade: number
          klass: number
          students: ResponseIBTKPPFSubmissionStatusDto[]
        }
      >,
    )
  }, [data])
            ...
            {group.students
              ...
              .map((student) => (
                <div
                  ...
                  onClick={action ? () => action(student.id, student.tkppf.id) : undefined}
                >
