      ...
      <div className="scrollable-wide w-full">
        <table className="w-full table-auto border-collapse">
          <thead className="text-center text-13 font-normal text-primary-gray-600">
            <tr>
              <td className="min-w-[80px] bg-primary-gray-50 p-2">과목</td>
              <td className="min-w-[100px] border-x border-b border-gray-200 bg-primary-gray-50 p-2">국어영역</td>
              <td className="min-w-[100px] border-x border-b border-gray-200 bg-primary-gray-50 p-2">수학영역</td>
              <td className="min-w-[100px] border-x border-b border-gray-200 bg-primary-gray-50 p-2">영어영역</td>
              <td className="min-w-[100px] border-x border-b border-gray-200 bg-primary-gray-50 p-2">한국사</td>
              {SubjectGroups[SubjectEnum.사회]
                .filter((subject) => SubjectScore[subject])
                .map((subject) => (
                  <td key={subject} className="min-w-[100px] border-x border-b border-gray-200 bg-primary-gray-50 p-2">
                    {subject}
                  </td>
                ))}
              ...
              <td className="min-w-[100px] border-x border-b border-gray-200 bg-primary-gray-50 p-2">국영수사과</td>
              <td className="min-w-[100px] border-x border-b border-gray-200 bg-primary-gray-50 p-2">국영수사</td>
              <td className="min-w-[100px] border-x border-b border-gray-200 bg-primary-gray-50 p-2">국영수과</td>
              <td className="min-w-[100px] border-b border-l border-gray-200 bg-primary-gray-50 p-2">국영수</td>
            </tr>
          </thead>
