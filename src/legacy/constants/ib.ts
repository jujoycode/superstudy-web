...
export const CAS_LEARNINGOUTCOME = [
  ...
  { id: 2, value: '도전과제 수행&새로운 역량 개발', name: 'newSkills' },
  { id: 3, value: 'CAS활동 추진&계획', name: 'initiativePlanning' },
  { id: 4, value: '노력과 인내심', name: 'perseverance' },
...
export const CAS_LEARNERPROFILE = [
  { id: 1, value: '탐구하는 사람' },
  { id: 2, value: '지식이 풍부한 사람' },
  { id: 3, value: '사고하는 사람' },
  { id: 4, value: '소통하는 사람' },
  { id: 5, value: '원칙을 지키는 사람' },
  { id: 6, value: '열린 마음을 지닌 사람' },
  { id: 7, value: '배려하는 사람' },
  { id: 8, value: '도전하는 사람' },
  { id: 9, value: '균형잡힌 사람' },
  { id: 10, value: '성찰하는 사람' },
