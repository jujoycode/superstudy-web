...
import { ReactComponent as KlassIcon } from '@/legacy/assets/svg/attendance-class.svg'
import { ReactComponent as UserIcon } from '@/legacy/assets/svg/attendance-user.svg'
