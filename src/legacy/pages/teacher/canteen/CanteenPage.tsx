  ...
  return (
    <Flex direction="col" className="h-screen w-full bg-gray-50" gap="2">
      ...
      <header className="w-full bg-white pt-12">
        <Box className="mx-auto w-full max-w-[1500px] px-6">
      ...
      {/* 메인 콘텐츠 */}
      <Box className="mx-auto w-full max-w-[1500px] px-6 pb-10">
        <Grid col={12} className="gap-6">
          {/* 왼쪽 컨텐츠 (캘린더와 일정) */}
          <GridItem colSpan={7} className="flex min-h-[680px] flex-col gap-6 rounded-xl bg-white p-6 shadow-sm">
            <CanteenCalendar
              value={selectedDate}
          ...
          {/* 오른쪽 컨텐츠 (급식 상세) */}
          <GridItem colSpan={5} className="flex flex-col rounded-xl bg-white p-6 shadow-sm">
            <CanteenDetailPage
