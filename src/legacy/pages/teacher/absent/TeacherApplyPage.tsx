        ...
        <Section>
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-500">반별 출석상태 조회/관리</div>
            </div>
            <RightArrow />
          </div>
          <div
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-500">교사별/학급별 시간표 조회 및 출석체크</div>
            </div>
            <RightArrow />
          </div>
          {me?.school?.isOutingActive !== OutingUse.NONE && (
            ...
            >
              <div>
                ...
                <div className="text-sm text-gray-500">조퇴증,외출증,확인증 / 조퇴,외출,확인 전 작성 서류</div>
              </div>
              <RightArrow />
            </div>
          )}
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-500">구,결석계 / 조퇴,외출,결과,지각,결석 후 작성 서류</div>
            </div>
            <RightArrow />
          </div>
          <div
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-500">신청,통보,결과보고서 / 체험학습 관련 작성 서류</div>
            </div>
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-500">학생 신상정보 관리, 상담카드</div>
            </div>
            <RightArrow />
          </div>
          <div
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-500">{`학생증, ${t(
                `absentTitle`,
                '결석신고서',
              )}, 체험학습 이력관리`}</div>
            </div>
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-500">상벌점 부여 및 조회</div>
            </div>
            <RightArrow />
          </div>
        </Section>
