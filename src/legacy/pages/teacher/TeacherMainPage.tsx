        ...
        <div className="flex grow flex-col border-r border-gray-200 bg-gray-50 pt-1 pb-4">
          ...
          <div className="scroll-box h-screen-13 mt-5 flex grow flex-col overflow-y-auto tracking-tighter">
            ...
            >
              {/* 출결 start */}
              <div className="flex">
                <div className="w-20 self-center text-center font-bold text-slate-600">{t(`attendance`)}</div>
                ...
                <div className="w-40">
                  ...
                  <div
                    ...
                    className={
                      openFieldTrip
                        ? 'font-base group flex cursor-pointer items-center rounded-t-md bg-gray-200 px-3 pt-3 pb-1 text-sm text-slate-600 select-none'
                        : 'font-base group flex cursor-pointer items-center rounded-t-md px-3 py-3 text-sm text-slate-600 select-none hover:bg-gray-100 hover:text-gray-900'
                    }
                  >
              ...
              {/* 정보 start */}
              <div className="flex">
                <div className="w-20 self-center text-center font-bold text-slate-600">{t(`information`)}</div>
              ...
              {/* 활동 start*/}
              <div className="flex">
                <div className="w-20 self-center text-center font-bold text-slate-600">{t(`activity`)}</div>
                <div className="my-2.5 mr-2 ml-3 border border-gray-200" />
                <div className="w-40">
                  <TeacherMainPageLink
                    ...
                    <Link
                      ...
                      className={
                        pathname.startsWith('/teacher/groups')
                          ? 'group flex items-center rounded-md bg-slate-600 px-3 py-3 text-sm font-bold text-white'
                          : 'font-base group flex cursor-pointer items-center rounded-md px-3 py-3 text-sm text-slate-600 hover:bg-gray-100 hover:text-gray-900'
                      }
                    >
                      활동 기록부(old)
                    </Link>
              ...
              {/* 일정 start */}
              <div className="flex">
                <div className="w-20 self-center text-center font-bold text-slate-600">{t(`schedule`)}</div>
              ...
              {/* 공지 start */}
              <div className="flex">
                <div className="w-20 self-center text-center font-bold text-slate-600">{t(`notice`)}</div>
              ...
              {/* 서비스 start */}
              <div className="flex">
                <div className="w-20 self-center text-center font-bold text-slate-600">{t(`more`)}</div>
                <div className="my-2.5 mr-2 ml-3 border border-gray-200" />
                <div className="w-40">
                  ...
                  <a
                    ...
                    target="blank"
                    className="font-base group flex cursor-pointer items-center rounded-md px-3 py-3 text-sm text-slate-600 hover:bg-gray-100 hover:text-gray-900"
                  >
                    {t(`contact_us`)}
                  </a>
                  <div
                    ...
                    className={
                      openGuide
                        ? 'font-base group flex cursor-pointer items-center rounded-t-md bg-gray-200 px-3 py-3 text-sm text-slate-600 select-none'
                        : 'font-base group flex cursor-pointer items-center rounded-t-md px-3 py-3 text-sm text-slate-600 select-none hover:bg-gray-100 hover:text-gray-900'
                    }
                  >
                    {t(`usage_guide`)}
                    ...
                    <div className="rounded-b-md bg-gray-200">
                      {manuals.map(({ id, url, title }) => (
                        <a key={id} href={url} target="_blank" rel="noreferrer">
                          <div className="font-base group flex cursor-pointer items-center px-3 py-3 text-sm text-slate-600 select-none hover:bg-gray-100 hover:text-gray-900">
                            {title}
                          </div>
                        </a>
                      ))}
              ...
              {(me?.role === Role.ADMIN || adminPermission) && (
                <Link
                  to="/admin"
                  className="flex items-center justify-between rounded-md border-2 border-slate-600 py-3 text-sm font-semibold"
                >
