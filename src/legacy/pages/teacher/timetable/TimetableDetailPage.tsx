  ...
  return (
    <div className="my-2 max-w-256 px-2">
      ...
      <div className="flex flex-row justify-between">
        ...
        <Flex width="fit-content" items="center" justify="start" gap="2">
          <Badge
          ...
          <tr>
            ...
            <th
              ...
              className={clsx(
                ...
                selectedDayNum === 1 ? 'bg-gray-200' : day === 1 ? 'bg-gray-1/10' : 'bg-gray-9',
              )}
            >
              {t('monday', '월')}
            </th>
            <th
              ...
              className={clsx(
                'min-w-max',
                selectedDayNum === 2 ? 'bg-gray-200' : day === 2 ? 'bg-brand-1/20' : 'bg-gray-9',
              )}
            >
              {t('tuesday', '화')}
            </th>
            <th
              ...
              className={clsx(
                'min-w-max',
                selectedDayNum === 3 ? 'bg-gray-200' : day === 3 ? 'bg-brand-1/20' : 'bg-gray-9',
              )}
            >
              {t('wednesday', '수')}
            </th>
            <th
              ...
              className={clsx(
                'min-w-max',
                selectedDayNum === 4 ? 'bg-gray-200' : day === 4 ? 'bg-brand-1/20' : 'bg-gray-9',
              )}
            >
              {t('thursday', '목')}
            </th>
            <th
              ...
              className={clsx(
                ...
                selectedDayNum === 5 ? 'bg-gray-200' : day === 5 ? 'bg-brand-1/20' : 'bg-gray-9',
              )}
            >
              {t('friday', '금')}
            </th>
            {hasSaturdayClass && (
              <th
                ...
                className={clsx(
                  ...
                  selectedDayNum === 6 ? 'bg-gray-200' : day === 6 ? 'bg-brand-1/20' : 'bg-gray-9',
                )}
              >
                {t('saturday', '토')}
              </th>
              ...
              {range(hasSaturdayClass ? 6 : 5).map((dayNum) => {
                ...
                return (
                  <td
                    ...
                    key={dayNum}
                    className={clsx(
                      'min-h-10.5 min-w-9.5 cursor-pointer border border-gray-300 px-1 py-2 text-xs md:text-base',
