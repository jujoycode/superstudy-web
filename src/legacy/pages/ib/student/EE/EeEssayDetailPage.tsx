...
export const EeEssayDetailPage = () => {
              ...
              <div className="flex flex-col items-start gap-3">
                <div className="flex w-full flex-row items-center justify-between">
                  ...
                  <Breadcrumb
                    data={{
                      진행상태: '/ib/student',
                      EE: `/ib/student/ee/${project.id}`,
                      '에세이 상세': `/ib/student/ee/${project.id}/essay/${essay.id}`,
                    }}
                  />
                </div>
              ...
              <div className="relative flex h-[812px] w-[848px] flex-col justify-between gap-6 rounded-xl bg-white p-6">
                ...
                <footer className="flex flex-row items-center justify-between">
                  ...
                  <ButtonV2
                    ...
                    variant="solid"
                    color="gray100"
                    onClick={() => history.push(`/ib/student/ee/${project.id}`, { type: 'ESSAY' })}
                  >
                    목록 돌아가기
                  </ButtonV2>
                </footer>
              ...
              <div className="flex h-[720px] w-[416px] flex-col gap-6 rounded-xl bg-white p-6">
                ...
                {type === 'feedback' ? (
                  ...
                  <div className="flex h-full w-full flex-col justify-between">
                    <CheckList studentId={me?.id} type="update" location="ESSAY" />
                    <div>
