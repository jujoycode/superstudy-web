...
export default function EERrsDetailPage() {
  ...
  const { data: rrs, isLoading: isRRSLoading } = useRRSGetById(id, rrsId)
  ...
  if (me == null || rrs === undefined) {
    return <IBBlank />
  }
  return (
    <div className="col-span-6">
      {(isIBLoading || isRRSLoading) && <IBBlank />}
      <IBLayout
        topContent={
          <div>
                ...
                <div className="flex w-full flex-row items-center justify-between">
                  ...
                  <Breadcrumb
                    data={{
                      ...
                      EE: `/teacher/ib/ee/${id}`,
                      'RRS 상세': `/teacher/ib/ee/${id}/rrs/${rrsId}`,
                    }}
                  />
                </div>
              ...
              <div className="flex w-[848px] flex-col justify-between rounded-xl bg-white p-6">
                ...
                <footer className={`flex flex-row items-center justify-end`}>
                  <ButtonV2
                    ...
                    variant="solid"
                    color="gray100"
                    onClick={() => history.push(`/teacher/ib/ee/${id}`, { type: 'RRS' })}
                  >
                    목록 돌아가기
                  </ButtonV2>
                </footer>
